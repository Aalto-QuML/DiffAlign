...
from src.utils.diffusion.helpers import mol_diagnostic_chains
...
class DiscreteDenoisingDiffusionMol(DiscreteDenoisingDiffusion):
    ...
    def score_batch(self, data, data_class=None, save_samples_as_smiles=False):
        ...
        from src.utils.setup import get_custom_fcd_statistic_precalculated, get_standard_fcd_statistic_precalculated
