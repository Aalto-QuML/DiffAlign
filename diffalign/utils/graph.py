...
from diffalign.utils.placeholder import PlaceHolder, encode_no_element
...
def get_graph_data_from_product_smi(product_smi, cfg):
    # This function has no reactants — only dummy nodes + product.
    # It also copies atom mapping to the reactant (dummy) side.
    # Because of its unique behavior, we keep the original implementation.
