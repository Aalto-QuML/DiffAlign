...
atom_types = ['none', 'O', 'C', 'N', 'I', 'Cl', 'Si', 'F', 'Br', 'S', 'B', 'Cu', 'Sn', 'P', 'Se', 'Zn', 'Mg', 'Au', 'SuNo']

allowed_bonds = {'O': [2], 'C': [4], 'N': [3], 'I': [1, 3, 5, 7], 'Cl': [1], 'Si': [4, 6], 'F': [1],
                 'Br': [1], 'S': [2, 4, 6], 'B': [3], 'Cu': [1, 2], 'Sn': [2, 4], 'P': [3, 5, 7], 
...
class Dataset(InMemoryDataset):
    def __init__(self, stage, root, size_test_splits=0, with_explicit_h=False, with_formal_charge=False):
        self.stage = stage
        self.root = root
...
class DataModule(AbstractDataModule):
    ...
    def prepare_data(self, shuffle=True, seed=0) -> None:
        ...
        datasets = {'train': Dataset(stage='train', root=root_path, with_explicit_h=self.with_explicit_h, with_formal_charge=self.with_formal_charge),
                    'val': Dataset(stage='val', root=root_path, with_explicit_h=self.with_explicit_h, with_formal_charge=self.with_formal_charge),
