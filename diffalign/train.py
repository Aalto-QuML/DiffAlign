...
def main(cfg: DictConfig):
    ...
    if cfg.general.wandb.resume:
        ...
        run.config['train']['epochs'] = orig_cfg.train.epochs # need this when resuming or otherwise overriding the epochs defined in the yaml file
        ...
        log.info(f"The new config with overrides: {cfg}")
    ...
    elif cfg.general.wandb.initialization_run_id:
        savedir = os.path.join(parent_path, 'init_models', cfg.general.wandb.initialization_run_id)
    else:
        savedir = None
