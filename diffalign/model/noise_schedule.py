...
from diffalign.model import tokenwisediffusion
from diffalign.model import blocktokenwisediffusion, maskdiffusion
...
class PredefinedNoiseScheduleDiscrete(torch.nn.Module):
    ...
    def __init__(self, noise_schedule, timesteps):
        ...
        if noise_schedule == 'cosine':
            betas = cosine_beta_schedule_discrete(timesteps, s=0)
        elif noise_schedule == 'cosine_alternate':
            betas = cosine_beta_schedule_discrete_alternate(timesteps)
        elif noise_schedule == 'cosine_alternate_2':
            betas = cosine_beta_schedule_discrete_alternate_2(timesteps)
        elif noise_schedule == 'custom':
