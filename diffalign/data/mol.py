...
def switch_between_bond_cw_ccw_label_and_cip_based_label(
    ...
    """
        ...
        cw_ccw_label: Chem.ChiralType.CHI_TETRAHEDRAL_CCW or Chem.ChiralType.CHI_TETRAHEDRAL_CW, defining the chirality of the atom either 
        in the bond-index based representation or the cip-based representation
        ...
        Uses the fact that rdkit assigns the CW/CCW label based on the order the bonds are attached to the atom in the atom.GetBonds() data structure. 
        The function transforms this to a label
