...
\begin{tikzpicture}
    ...
    \node[label] at (.5,1.02) {\textbf{Product}};
    \node[label] at (.2,0.58) {\textbf{High atom count}};
    \node[label] at (.2,0.5) {\textbf{guidance}};
    \node[label] at (.8,0.58) {\textbf{Low atom count}};
    \node[label] at (.8,0.5) {\textbf{guidance}};
