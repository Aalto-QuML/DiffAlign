...
\begin{document}
      ...
      \begin{tikzpicture}[anchor=center]
        ...
        \node at (0,-1.3) {target};
        \node at (4,-1.3) {source};   
        \node[align=center,text width=6cm] at (2,0){ %(-.2,2.75) {
          \scalebox{0.7}{\Aligning} \\
          \scalebox{0.5}{\textbf{the target and source}} \\
          \scalebox{0.5}{\textbf{using matching node identifiers}}
        };
